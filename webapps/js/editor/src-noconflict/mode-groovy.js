...
var JavaScriptHighlightRules = function(options) {
    var keywordMapper = this.createKeywordMapper({
        "variable.language":
            "Array|Boolean|Date|Function|Iterator|Number|Object|RegExp|String|Proxy|Map|List"  + // Constructors
...
var GroovyHighlightRules = function() {
    ...
    var langClasses = (
        ...
        "Cloneable|Class|CharSequence|Comparable|String|Object|Map|List"
    );
