...
function createTree(p_div,p_backColor,p_contextMenu) {
	var tree = {
		...
		createNode: function(p_text,p_expanded, p_icon, p_parentNode,p_tag,p_contextmenu,obj,type) {
			v_tree = this;
			node = {
				obj: obj,
				type : type,
				...
				createChildNode: function(p_text,p_expanded,p_icon,p_tag,p_contextmenu,obj,type) { return v_tree.createNode(p_text,p_expanded,p_icon,this,p_tag,p_contextmenu,obj,type); }
			}
